...
\normalsize Co-author on 139 citable papers as part of the CMS collaboration (inSPIRE HEP, October 2015) and have an $h_{hep}$ index of 30. Selected papers with substantial contributions are given below: %!! make sure up to date
...
\cventry{2014}{CMS Collaboration}{`Search for invisible decays of Higgs bosons in the vector boson fusion and associated ZH production modes'}{Eur. Phys. J. C 74 (2014) 2980}{}{
  ...
  \myitem This paper has received 124 citations (inSPIRE HEP, October 2015)
  \end{itemize}
  \vspace{.1cm}
}
